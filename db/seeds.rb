...
q9 = Question.create(question: "hich one of these films are shot entirely in one-take?", difficulty: "medium", correct: "Russian Ark", wrong_one: "Good Will Hunting", wrong_two: "Birdman", wrong_three: "Schindler's List")
